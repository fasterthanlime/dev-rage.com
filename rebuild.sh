...
for img in *.png; do
  ...
  cat ../template.wtfbash | sed "s/TITLEGOESHERE/$title/g" | sed "s/NUMBERGOESHERE/$number/g" | sed "s/CONTENTGOESHERE/<img src=\"https:\/\/github.com\/nddrylliog\/dev-rage\/blob\/master\/$img?raw=true\">/" > ../public/$number.html
